...
A work in progress python script as an alternative to eq.hangout.audio. I didnt like the feeling that when the servers are offline, I cant push EQ's to my dongle.
